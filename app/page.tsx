        ...
        <div className="mt-10 max-w-2xl">
          ...
          >
            <div className="flex flex-col gap-3 sm:flex-row">
              ...
              <button
                type="submit"
                className="border border-[#E2852B] bg-[#E2852B] px-7 py-4 font-display text-sm font-black uppercase tracking-widest text-[#11161E] transition hover:-translate-y-0.5 hover:bg-[#F09A42]"
              >
                Get My Card
              </button>
            </div>
          ...
          <div className="mt-8 grid gap-5 md:grid-cols-2">
            ...
            <div className="border border-chalk/10 bg-chalk/[0.02] p-6 md:p-8">
              ...
              <p className="mt-4 font-body text-sm leading-relaxed text-chalk/50">
                ...
                rating, current form, six player stats, dimensions and
                comparison.
              </p>

              <div className="mt-8 grid grid-cols-3 gap-2">
                {["OVR", "FORM", "STATS"].map((item) => (
                  <div key={item} className="border border-chalk/10 p-3">
