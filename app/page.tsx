...
export default function HomePage() {
  ...
  return (
    <main className="mow-lines relative min-h-screen overflow-hidden">
      ...
      {/* Two ways to see your profile — Career Card is a real second path, not a hidden link.
          Deliberately below the fold and visually secondary to the primary hook above. */}
      <section className="relative z-10 mx-auto max-w-5xl px-6 py-16">
        ...
        <div className="mt-8 max-w-sm md:ml-auto md:mt-[-2px]">
          <CareerCardPreview />
        </div>
      </section>
